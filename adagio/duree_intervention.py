...
# TODO: on a d'autre chose � faire, il faut faire le merge avec
...
# Il ne reste plus qu'� g�n�rer des donn�es sur le temps
...
#comment identifier un v�hicule qui a �t� utilis� de deux fa�ons ?
...
# TODO: d�but et fin d'intervention
...
#=> on charge plutt�t les donn�es � la fin du fichier
